...
export default function GameIcon({ games, handleLikeChange, likes, onGameUpdated }) {
  ...
  useEffect(() => {
    const checkIfGameHasBeenLiked = async () => {
      try {
        ...
        console.log("check whether user has liked:", JSON.stringify(response.data, null, 2));
